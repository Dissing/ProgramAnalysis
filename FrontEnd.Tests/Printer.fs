...
[<Test>]
let PrinterArith () =
    let statement = (ArithmeticBinary (ArithmeticBinary (ArithmeticUnary(Negation, Loc (Identifier "Var")), Subtract, (ArithmeticUnary(Negation, Loc (Field ("R", "fst"))))), Divide, (IntLiteral 10)))
...
let PrinterBoolArith () =
    let statement = (Comparison (ArithmeticBinary (ArithmeticUnary(Negation, Loc (Identifier "Var")), Subtract, (ArithmeticUnary(Negation, Loc (Field ("R", "fst"))))), GreaterEqual, (IntLiteral 10)))
